...
> 在飞书群里组建你的 AI 团队：**张总（产品总监）+ 阿博（产品经理）+ 阿布（研发工程师）**
>
> 你在群里 @张总 发需求 → 三人自动协作讨论 → 出结论
...
| 角色 | 名字 | 职责 | 风格 |
|:---:|:---:|:---|:---:|
| 🟡 **总监** | 张总 | 调度者，拆解任务、指派分工、总结决策 | 权威不强势 |
| 🟢 **产品经理** | 阿博 | 分析用户需求、市场机会、产品方向 | 热情，用表情 🎯 |
| 🔵 **研发工程师** | 阿布 | 评估技术可行性、成本、开发周期 | 冷静，用数据说话 |

**工作流程：**
```
你在群里 @张总 我们想做AI客服，分析一下
         ↓
张总 → @阿博 你先做产品分析
         ↓
阿博 → @张总 用户需求是...，目标用户是...，建议...🎯
         ↓
张总 → @阿布 你评估技术可行性
         ↓
阿布 → @张总 技术上可行，周期约3个月，成本约...
         ↓
张总 → 【完整总结】产品分析结论 + 技术评估结论 + 综合建议
```
