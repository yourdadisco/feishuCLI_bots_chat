...
# ===== 极简人设 - 直接告诉 AI 该做什么 =====
$DSys="你是产品总监，产品总监。你的团队：产品经理（产品经理）、研发（研发）。
工作流程：用户给了一个具体任务。
第1步：回复'收到任务。@产品经理 你先做产品分析。'
第2步：等产品经理回复后，回复'@研发 你做技术评估。'
第3步：等研发回复后，给用户一份完整总结。
全程围绕用户的任务，不要说'需要更多信息'。每条消息开头的@人。"

$PSys="你是产品经理，产品经理。以'@产品总监'开头说话。用户有一个具体任务，产品总监@了你。你的工作：针对用户任务做产品分析（用户需求、目标用户、市场机会、产品建议）。用表情符号。直接分析，不要问问题。"

$ESys="你是研发，技术负责人。以'@产品总监'开头说话。用户有一个具体任务，产品总监@了你。你的工作：针对用户任务做技术评估（可行性、开发周期、技术方案建议）。不用表情符号。直接评估，不要问问题。"
...
if(!$m){$m="收到任务。@产品经理 你先做产品分析，分析用户需求、目标用户和市场机会。"}
Log "产品总监: $m" 'Yellow';Send $dc $m;$global:History+="产品总监: $m";Start-Sleep 4

# 2. 产品经理
Log "产品经理思考..." 'DarkGray'
$m=LLM -sys $PSys -ctx (Ctx) -name '产品经理' -task $Task -role '产品经理'
if(!$m){$m="@产品总监 用户需求是$Task，核心用户是中小电商，市场机会很大🎯"}
Log "产品经理: $m" 'Cyan';Send $pc $m;$global:History+="产品经理: $m";Start-Sleep 4

# 3. 产品总监@研发
Log "产品总监思考..." 'DarkGray'
$m=LLM -sys $DSys -ctx (Ctx) -name '产品总监' -task $Task -role '产品总监'
if(!$m){$m="@研发 你做技术评估，评估可行性、开发周期和成本。"}
Log "产品总监: $m" 'Yellow';Send $dc $m;$global:History+="产品总监: $m";Start-Sleep 4

# 4. 研发
Log "研发思考..." 'DarkGray'
$m=LLM -sys $ESys -ctx (Ctx) -name '研发' -task $Task -role '研发'
if(!$m){$m="@产品总监 技术上可行，预估周期3个月，建议用微服务架构。"}
Log "研发: $m" 'Green';Send $ec $m;$global:History+="研发: $m";Start-Sleep 4

# 5. 产品总监总结
Log "产品总监总结..." 'DarkGray'
$m=LLM -sys $DSys -ctx (Ctx) -name '产品总监' -task $Task -role '产品总监'
if(!$m){$m="【总结】产品分析：... 技术评估：... 建议：..."}
Log "产品总监: $m" 'Yellow';Send $dc $m;$global:History+="产品总监: $m"
